...
public class LoggersResource extends RestResource {
    ...
    private static final Map<String, Subsystem> SUBSYSTEMS = ImmutableMap.<String, Subsystem>of(
            "graylog", new Subsystem("Graylog", ImmutableList.of("org.graylog2", "org.graylog"), "系统内部索引的消息."),
            "indexer", new Subsystem("Indexer", "org.elasticsearch", "索引相关的消息."),
            "authentication", new Subsystem("Authentication", "org.apache.shiro", "用户认证相关的消息."),
            "sockets", new Subsystem("Sockets", "netty", "Socket通信相关的信息."));
